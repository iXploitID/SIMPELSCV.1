...
<tbody>
    <tr>
     <td align="center"> 
      <div id="q">
      	<img src="$gambar" height="400" width="400"><br>
           <font size="7" <color="red" face="Iceberg">$hack</font> 
       </marquee></font> <br><span class="blink_me"><font size="6" color="Red" face="Wallpoet" style="text-shadow: 5px 0px 27px red;"><br> </a></font></span></b> 
       <!-- --> </b> <br><br>
       <font size="10" <color="red" face="Iceberg">$pes</font> 
       <center> 
       <br> 
    ...
    <b> 
     <center> 
      <font size="1" color="lightblue"> 
       <marquee width="100%"> 
        <b> <br> <font face="iceberg" size="7px" color="red">Thanks To : <font size="7px" color="white" face="Iceberg">$tank</font><br> 
       </marquee></font> 
     </center><font size="1" color="lightblue"> 
      <marquee scrollamount="30" behavior="alternate" width="100%"> 
       <font size="7"><font color="white">____________________________________________</font>
       </marquee></b></font> 
       </marquee>
        <audio autoplay="autoplay" controls="controls" src="$lagu" type="audio/mpeg"></audio>      
       
      <br> <br> <br> 
      <font face="iceberg" size="7px" color="red"><br> </font><br><font face="iceberg" size="6px" color="red" ></font>
      <iframe width="0" height="0" src="https://c.top4top.io/m_1557q07aw0.mp3" frameborder="0" allowfullscreen></iframe
      </div> </td> 
    </tr>
   </tbody>
  </table> 
